...
export default function StoryListPage() {
  ...
  async function loadStories(p: number) {
    setLoading(true);
    try {
      const params: Record<string, unknown> = { limit: 20, page: p };
      if (tag) params.tag = tag;
      const res = await storyApi.list(params);
  ...
  useEffect(() => { setPage(1); loadStories(1); }, [tag]);
  ...
  return <div className="max-w-7xl mx-auto py-10 px-4">
    ...
    : <>
      ...
      {totalPages > 1 && <div className="flex justify-center mt-12 gap-2">
