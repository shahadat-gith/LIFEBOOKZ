...
export const Icons = {
 ...
 chevronDown: HiOutlineChevronDown, chevronLeft: HiOutlineChevronLeft, chevronRight: HiOutlineChevronRight, arrowLeft: HiOutlineArrowLeft,
 user: HiOutlineUser, userAdd: HiOutlineUserAdd, login: HiOutlineLogin, logout: HiOutlineLogout, briefcase: HiOutlineBriefcase,
 lock: HiOutlineLockClosed, mail: HiOutlineMail, book: HiOutlineBookOpen, edit: HiOutlinePencil,
 trash: HiOutlineTrash, clock: HiOutlineClock, tag: HiOutlineTag, document: HiOutlineDocumentText,
 documentAdd: HiOutlineDocumentAdd, plus: HiOutlinePlus, check: HiOutlineCheck, save: HiOutlineSave,
 ...
 videoCamera: HiOutlineVideoCamera, filter: HiOutlineFilter,
