...
function TB({ onClick, active, children, label, disabled }) {
  return (
    <button
      type="button"
      onClick={onClick}
...
function Toolbar({ editor }) {
  ...
  async function handleImageUpload(e) {
    ...
    try {
      ...
      // Insert figure with image and caption placeholder
      editor
        .chain()
        .focus()
        .insertContent({
...
export default function StoryEditor({ content, onChange, placeholder = "Write your story...", editable = true }) {
